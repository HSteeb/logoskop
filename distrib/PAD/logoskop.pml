...
<PADGEN_PML>
	...
	<CompanyName />
	<Program_Info>
		<Program_Name>Logoskop</Program_Name>
		<Program_Version>3.0.2.2011</Program_Version>
		...
		<Program_OS_Support>Win2000,Win7 x32,Win7 x64,Win98,WinVista,WinXP</Program_OS_Support>
		<Program_Language>English,German</Program_Language>
		<Program_Change_Info>The Word 2011</Program_Change_Info>
		<Program_Specific_Category>Home/Hobby</Program_Specific_Category>
		<Program_Category_Class>Home &amp; Hobby::Religion</Program_Category_Class>
		<Program_System_Requirements />
		<File_Info>
			<File_Size_Bytes>942198</File_Size_Bytes>
			<File_Size_K>920</File_Size_K>
			<File_Size_MB>0.90</File_Size_MB>
		</File_Info>
		<Expire_Info>
	...
	<Program_Descriptions>
		<English>
			<Keywords />
			<Char_Desc_45 />
			<Char_Desc_80>Shows The Word - two associated Bible verses for each day of the year</Char_Desc_80>
			<Char_Desc_250 />
			<Char_Desc_450>Shows The Word - two associated Bible verses for each day of the year in multiple languages, published by Project Bible 2.0; supports online update of the Bible verses and optionally creates an email signature from the Bible verses; source code available for developers. The installer contains The Word 2011 in ten languages.</Char_Desc_450>
			<Char_Desc_2000 />
		</English>
		<German>
			<Keywords />
			<Char_Desc_45 />
			<Char_Desc_80>Zeigt "Das Wort" - zwei sich ergänzende Bibelworte für jeden Tag des Jahres</Char_Desc_80>
			<Char_Desc_250 />
			<Char_Desc_450>Zeigt "Das Wort" - zwei sich ergänzende Bibelworte für jeden Tag des Jahres in mehreren Sprachen, herausgegeben vom Projekt Bibel 2.0; unterstützt die Online-Aktualisierung der Bibelworte und erzeugt aus den Bibelworten auf Wunsch eine E-Mail-Signatur; Quelltext für Entwickler erhältlich. Die Installation enthält Das Wort 2011 in zehn Sprachen.</Char_Desc_450>
			<Char_Desc_2000 />
		</German>
	</Program_Descriptions>
	<Web_Info>
		<Application_URLs>
			<Application_Info_URL>http://bible2.net/content/download/win32</Application_Info_URL>
			<Application_Order_URL />
			<Application_Screenshot_URL>http://bible2.net/packet/logoskop/logoskop.jpg</Application_Screenshot_URL>
			<Application_Icon_URL>http://bible2.net/packet/logoskop/logoskop.gif</Application_Icon_URL>
			<Application_XML_File_URL>http://bible2.net/packet/logoskop/logoskop.xml</Application_XML_File_URL>
		</Application_URLs>
		<Download_URLs>
			<Primary_Download_URL>http://bible2.net/packet/2011/Logoskop_2011_Installer.exe</Primary_Download_URL>
