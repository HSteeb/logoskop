/* ----------------------------------------------------------------------
  ...
  $Id: DownloadDlg.h 3011 2008-11-29 09:37:12Z helmut $
...
MPL or the GPL.
====================================================================== */
#if !defined(AFX_DOWNLOADDLG_H__INCLUDED_)
#define AFX_DOWNLOADDLG_H__INCLUDED_
...
class IDownloadDlg {
public:
  virtual ~IDownloadDlg() {};

  virtual int DoModal() = 0;
};

namespace NDownloadDlg {
  // resulting IOrganizeDlg must be freed by caller
  IDownloadDlg& MakeDownloadDlg(
